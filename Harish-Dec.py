...
→   Owner      :  Rahullslam000
→   Facebook   :  Rahullslam000
→   Github     :  Rahullslam000
→   Tool Type  :  \x1b[1;95m
...
try:
    ...
    proxy = requests.get('https://github.com/Rahullslam/Rahul11/blob/main/Approval.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://github.com/Rahullslam/Rahul11/blob/main/Approval.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
...
def Herry():
    ...
    if Herryx =='5':
        exit()
    if Herryx =='3':
        os.system('xdg-open https://github.com/Rahullslam/Rahul11 ')
    if Herryx =='4':
